...
############################################################################################################################################
def MainProject(fits_file, isBackUp, isCosmic, isCoordCorr):
...
# coordinate correction
    coordfix.coordcorr(fits_file, filt, isBackUp, isCosmic, isCoordCorr)
...
############################################################################################################################################
def MainProject_dual(fits_file1, fits_file2, isBackUp, isCosmic, isCoordCorr):
    # choose filter
...
# coordinate correction
    coordfix.coordcorr(fits_file1, filt1, isBackUp, isCosmic, isCoordCorr)
    coordfix.coordcorr(fits_file2, filt2, isBackUp, isCosmic, isCoordCorr)
